...
import { get_containers, get_pickup_completed_orders } from '../../../Constans/ApiConstans';
import * as types from '../../Types';

export const getpickupcompleteorders = (payload: any, lantype: any) => {
    ...
    await CallApi('POST', get_pickup_completed_orders, payload)
      .then(res => {
        ...
        if (res.success === 1) {
          ...
          dispatch({ type: types.READY_TO_SHIPORDERS, payload: res.data.readytoshiporders });
          dispatch({ type: types.PICKUP_COMPLETED, payload: res.data.pickupcompleted });
          dispatch({ type: types.LABEL_PRINTED_ORDERS, payload: res.data.labelprintedorders });
